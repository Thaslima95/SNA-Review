    ...
    <div className="bg-slate-50 min-h-screen font-sans text-slate-900">
      ...
      <section id="research-highlights" className="py-24 scroll-mt-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <article className="bg-white p-8 md:p-16 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 relative overflow-hidden">
            ...
            <div className="prose prose-lg prose-slate max-w-none font-serif leading-loose text-slate-600 relative z-10 
              prose-headings:font-sans prose-headings:font-bold prose-headings:text-slate-900 prose-headings:tracking-tight
              prose-p:mb-8 prose-blockquote:border-l-4 prose-blockquote:border-[#991b1b] prose-blockquote:bg-slate-50 prose-blockquote:py-4 prose-blockquote:px-6 prose-blockquote:rounded-r-lg prose-blockquote:not-italic
              first-letter:text-6xl first-letter:font-bold first-letter:text-[#991b1b] first-letter:mr-3 first-letter:float-left first-letter:leading-[0.8]">
              ...
              <blockquote>
                <p className="mb-0 text-slate-700 italic">
              ...
              <p>
                ...
                <span className="block mt-4 font-medium text-[#991b1b]">“I am contemplating yet another sabbatical, probably a dangerous thing to do,” quips Prof Halliwell.</span>
              </p>

              <h3>Prof Halliwell and National University of Singapore</h3>
              <p>
              ...
              <h3>Neuroscience in Singapore</h3>
              <p>
              ...
              <h3>Advice to young scientists entering the field</h3>
              <p>
              ...
              <div className="bg-slate-50 p-6 rounded-xl border border-slate-100 not-prose">
                <Quote className="w-8 h-8 text-[#991b1b] mb-4 opacity-50" />
                ...
                <div className="text-sm font-bold text-[#991b1b] uppercase tracking-wide">— Prof. Barry Halliwell</div>
              </div>
            </div>
          </article>
